...
begin
  ...
  cmdSnoozeN.Parameters[3].Value := AppID; // AppID
...
begin
  ...
  cmdSnoozeN.Parameters[1].Value := qryRemind.FieldByName('EntityID').AsInteger; // EntityID
  cmdSnoozeN.Parameters[2].Value := qryRemind.FieldByName('NoteNo').AsInteger; // NoteNo
  cmdSnoozeN.Execute;
  qryRemind.Requery;
end;
