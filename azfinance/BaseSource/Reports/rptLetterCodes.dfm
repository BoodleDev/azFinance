inherited repLettercodes: TrepLettercodes
  Tag = 49
  Left = 192
  Top = 133
  Width = 544
  Height = 375
  Caption = 'repLettercodes'
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 13
  inherited QuickReport: TQuickRep
    DataSet = dtmLoadLet.qryLetterCodes
    Functions.DATA = (
      '0'
      '0'
      #39#39)
    ...
    inherited qbDetail: TQRBand
      ...
      object txtApplication: TQRDBText
        Left = 536
        Top = 0
        Width = 54
        Height = 17
    ...
    inherited qrGroup: TQRGroup
      ...
      object lblApplication: TQRLabel
        Left = 536
        Top = 0
        Width = 62
        Height = 17
