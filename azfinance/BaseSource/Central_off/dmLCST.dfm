object dtmLCST: TdtmLCST
  ...
  object cdsContract: TClientDataSet
    ...
    object cdsContractLoanAdvance: TCurrencyField
      FieldName = 'LoanAdvance'
    end
    object cdsContractPayableInstallment: TCurrencyField
      FieldName = 'PayableInstallment'
    end
  ...
  object qryLoanAdvance: TADOQuery
    Parameters = <
      item
        Name = 'LID'
    ...
    SQL.Strings = (
      'SELECT * FROM lsLDLoanAdvance'
      'WHERE LoanID = :LID'
      'AND AdvanceDate >= :DTE1'
      'AND AdvanceDate <= :DTE2'
