inherited repClientState: TrepClientState
  Tag = 1048
  Left = 220
  Top = 176
  Width = 635
  Height = 444
  Caption = 'repClientState'
  PixelsPerInch = 96
  TextHeight = 13
  inherited QuickReport: TQuickRep
    Left = 16
    Top = 16
    DataSet = dtmLS.cdsAcc
    Functions.Strings = (
      'PAGENUMBER'
      'COLUMNNUMBER'
      'REPORTTITLE'
    ...
    inherited qbDetail: TQRBand
      ...
      object qdbtC: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'if(Credit<0,Credit,'#39#39')'
        Mask = 'R###,#0.00;(R###,#0.00)'
        FontSize = 8
      end
    end
    ...
    inherited repTitleBand: TQRBand
      ...
      inherited qshpLoanDet: TQRShape [1]
        Top = 333
        Height = 92
        Size.Values = (
      ...
      inherited qlrepName: TQRLabel [2]
        Left = 255
        Top = 124
        Width = 188
        Size.Values = (
        ...
        Caption = 'Client account statement'
        FontSize = 12
      end
      inherited qlCpy: TQRLabel [3]
        Left = 288
        Top = 47
        Enabled = False
        Size.Values = (
      ...
      inherited qlCpyName: TQRLabel [4]
        Top = 151
        Size.Values = (
          44.979166666666670000
      ...
      inherited shpTitleTop: TQRShape [7]
        Top = 143
        Size.Values = (
      ...
      inherited shpTitleBot: TQRShape [8]
        Top = 179
        Size.Values = (
          2.645833333333333000
          0.000000000000000000
      ...
      inherited qlClientDet: TQRLabel [10]
        Top = 202
        Size.Values = (
          44.979166666666670000
          127.000000000000000000
      ...
      inherited qlNameSurname: TQRLabel [11]
        Top = 221
        Size.Values = (
          44.979166666666670000
          127.000000000000000000
      ...
      inherited qlAccCode: TQRLabel [12]
        Top = 261
        Size.Values = (
          44.979166666666670000
      ...
      inherited qdbtPersonKey: TQRDBText [13]
        Top = 261
        Size.Values = (
          44.979166666666670000
    ...
    object QRBand1: TQRBand
      ...
      object QRMemo1: TQRMemo
        ...
        Lines.Strings = (
            ...
            'The information contained in this Loan Statement ("the Statement' +
            '") reflects the balancing outstanding, including interest and ar' +
            'rears, '
      ...
      object QRMemo2: TQRMemo
        ...
        Lines.Strings = (
            ...
            'The Statement is rendered to you without prejudice to any right ' +
            'Bruma Finance may have in terms of the Loan Agreement, or otherw' +
            'ise.')
        ParentFont = False
        Transparent = False
        WordWrap = True
      ...
      object QRMemo3: TQRMemo
        ...
        Lines.Strings = (
            ...
            'Bruma Finance shall not be responsible for any errors and/or omi' +
            'ssions should the information contained in the Statement be inco' +
            'rrect.')
        ParentFont = False
        Transparent = False
        WordWrap = True
      ...
      object QRMemo4: TQRMemo
        ...
        Lines.Strings = (
            ...
            'Bruma Finance reserves the right to claim any amount erroneously' +
            ' not reflected in the Statement, for any reason whatsoever, as a' +
            'nd '
      ...
      object QRMemo5: TQRMemo
        ...
        Lines.Strings = (
            ...
            'Nothing contained in the Statement shall detract from the Loan A' +
            'greement entered into between you and Bruma Finance, which remai' +
            'ns '
      ...
      object QRMemo6: TQRMemo
        ...
        Lines.Strings = (
            ...
            'Should there be an error in the Statement or should you have any' +
            ' queries then please contact Bruma Finance.')
        ParentFont = False
        Transparent = False
        WordWrap = False
        FontSize = 8
      ...
      object QRMemo7: TQRMemo
        ...
        Lines.Strings = (
            ...
            'The amount reflected in the Statement is not a settlement balanc' +
            'e. Should you require a settlement balance please feel free to c' +
            'ontact '
          'Bruma Finance.')
        ParentFont = False
        Transparent = False
