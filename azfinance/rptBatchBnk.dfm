inherited repBatchBnk: TrepBatchBnk
  Tag = 1084
  Left = 161
  Top = 126
  Width = 498
  ...
  inherited QuickReport: TQuickRep
    DataSet = dtmBatchTrans.spBBankDet
    Functions.DATA = (
      '0'
      '0'
      #39#39)
    ...
    inherited qbDetail: TQRBand
      ...
      object QRExpr1: TQRExpr
        ...
        Transparent = True
        WordWrap = True
        Expression = 'if(BBCode<>'#39#39',if(AccNo<>'#39#39',if(AccName<>'#39#39','#39#39','#39'~'#39'),'#39'#'#39'),'#39'@'#39')'
        FontSize = 8
      end
