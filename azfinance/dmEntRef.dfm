object dtmEntRef: TdtmEntRef
  ...
  object qryEntity: TADODataSet
    ...
    CommandText = 
      ...
      'r,'#13#10'  RegNo, RefFld1, RefFld2, Title, Name, Name2, TelNo1, TelNo' +
      '2, TelNo3, '#13#10'  FaxNo, UserID, DateChange, UserAdd, DateAdded, Em' +
      'ail, WebSite'#13#10'from Entitydata'#13#10'where EntityID = :EntID'#13#10
    Parameters = <
      item
        Name = 'EntID'
        Attributes = [paSigned]
  ...
  object qryAddress: TADODataSet
    ...
    CommandText = 
      'select EntityID, EntType, AddressType, Address1, Address2, Addre' +
      'ss3, Address4, AddressCode, UserID'#13#10'from Address'#13#10'where EntityID' +
