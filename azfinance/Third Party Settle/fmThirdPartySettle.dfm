object frmThirdPartySettle: TfrmThirdPartySettle
  ...
  object grdDebtRecord: TDBGrid
    ...
    DataSource = dtmLoanC.dtsDebtRecord
    ...
    TitleFont.Style = []
    OnDrawColumnCell = grdDebtRecordDrawColumnCell
    OnDblClick = grdDebtRecordDblClick
    Columns = <
      item
        Alignment = taCenter
        Expanded = False
  ...
  object ppmDebt: TPopupMenu
    Left = 328
    Top = 344
    object Add1: TMenuItem
      Caption = 'Add'
      OnClick = grdDebtRecordDblClick
    end
