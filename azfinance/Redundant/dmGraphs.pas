...
uses
  ...
  Db, mxDB, mxstore, mxtables, ADODB, Unit32;

type
  TdtmGraphs = class(TDataModule)
    dsrcLoanType: TDecisionSource;
    ...
    dcLoanType: TDecisionCube;
    dcArrFreq: TDecisionCube;
    dsrcArrFreq: TDecisionSource;
    decDellRate: TADOStoredProc;
    dcDellRate: TDecisionCube;
    dsrcDellRate: TDecisionSource;
