inherited frmSMSCreate: TfrmSMSCreate
  Tag = 1081
  Left = 199
  Top = 89
  Caption = 'azFince create SMS upload'
  OldCreateOrder = True
  OnClose = FormClose
  OnCreate = FormCreate
  PixelsPerInch = 96
  ...
  inherited tlbDBBase: TToolBar
    ...
    object ToolButton1: TToolButton
      Left = 0
      Top = 36
      Caption = 'Create 1 sms'
      ImageIndex = 22
      Wrap = True
      OnClick = ToolButton1Click
    end
    object btnBuildSMS: TToolButton
      Left = 0
      Top = 72
      Caption = 'Build SMS'
      ImageIndex = 26
      OnClick = btnBuildSMSClick
    end
  end
  inherited pnlBBase: TPanel
    Width = 466
    object mainGrid: TDBGrdClr
      Left = 0
      Top = 104
      Width = 466
      Height = 113
    ...
    object Panel2: TPanel
      ...
      object Panel3: TPanel
        ...
        object cbxSmsType: TComboBox
          ...
          ItemHeight = 13
          TabOrder = 0
          OnChange = cbxSmsTypeChange
          Items.Strings = (
            'Custom SMS')
        end
        object reDB: TDBRichEdit
          Left = 304
          Top = 8
          Width = 25
          Height = 14
