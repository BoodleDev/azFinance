inherited frmRepLSum: TfrmRepLSum
  Tag = 1035
  Left = 234
  Top = 221
  Width = 652
  Height = 297
  Caption = 'Loan summary reports'
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 13
  inherited pnlBBase: TPanel [0]
    Width = 600
    Height = 259
    TabOrder = 2
  end
  object pnlMain: TPanel [1]
    ...
    object grdLoanSum: TcdsSortGrd
      ...
      TitleFont.Style = []
      OnTitleClick = grdLoanSumTitleClick
      OddColor = clInfoBk
      SelColor = clNavy
  ...
  inherited tlbDBBase: TToolBar [2]
    Left = 600
    Height = 259
    ButtonWidth = 37
