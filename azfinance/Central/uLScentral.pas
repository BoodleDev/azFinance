...
function GetInstFreqDesc(inType: integer):string; overload;
function GetInstFreqDesc(inType, Period: integer):string; overload;
...
begin
  case Status of
    ...
    lnsReview      : Result := $000080FF; //Orange
    lnsDeclined    : Result := clRed;    // Declined
    lnsCancelled   : Result := clRed;    // Cancelled
    lnsPreApproved : Result := $00FFA4A4;   // Pre-approved
    lnsApproved    : Result := $005BFF5B;   // Active
...
begin
  ...
  StrList.Add(lndReview     + '=' + IntToStr(lnsReview));
...
begin
  case inType of
    ...
    ltactHPBI,ltactHPABI : Result := 'Fortnights';
    else
      Result := 'Months';
  end;
end;
...
begin
  case inType of
    ltactHPWI,ltactHPAWI : Result := 'Week';
    ltactHPBI,ltactHPABI : Result := 'Fortnight';
    else
      Result := 'Month';
  end;
