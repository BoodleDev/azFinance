...
const
  ...
  { Deposit - C 7,9
              D 10,11}
  actCA  = '1,2,3,5,6,11,12,15,16,17,18,22,24';
  actLA  = '1,2,4,11,12,13,14,15,16,17,18,22,24';
  actDA  = '7,8,9,10';
 ...
 { AdrSpouse= 5; //Spouse address
  ...
  lsNewEmployer = 100001024;
  lsEmployer = 100001001;
  lsFunder   = 100001002;
  lsBranch   = 100001003;
  lsDebtCol  = 100001004;
  lsAttorney = 100001005;
  lsPayBranch = 100001006;
  lsLO       = 100001007;
  lsLO2      = 100001010;
  lsIntermediary = 100001025;
  lsLOMan    = 100001008;
  ...
  VerifyErrMes : array [0..10] of String = (
    ...
    'Error:  Transaction effective date cannot be on or before the current Month-end date', //6
    'Warning:  Transaction effective date < Loan startdate', //7
    'Error:  Invalid transaction type', //8
    'Warning:  Loan Status is Closed', //9
    'Error: Bad Debt Transactions allocated to a Non Bad Debt Account'); //10
  ...
  lnsReview      = 5;   // Declined Loan Under Review
  ...
  lndPreApproved = 'Pre-Approved';//'Approved subject to';
