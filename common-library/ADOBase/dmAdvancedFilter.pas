...
type
  TdtmAdvancedFilter = class(TDataModule)
    ...
    dsDefinitions: TADODataSet;
    cmdAddDefintionFilter: TADOCommand;
    cmdClearDefinition: TADOCommand;
    cmdAddDefintionField: TADOCommand;
    qryDefinitionFilter: TADOQuery;
    qryDefinitionField: TADOQuery;
