...
type
  TdtmNotes = class(TDataModule)
    ...
    qryAttachRecID: TAutoIncField;
    qryAttachAppID: TIntegerField;
    qryAttachEntID: TIntegerField;
    qryAttachMasterID: TIntegerField;
    qryAttachTypeID: TIntegerField;
    qryAttachDocType: TIntegerField;
    qryAttachDocName: TStringField;
    qryAttachDescription: TStringField;
    qryAttachHyperlink: TStringField;
    qryAttachRefNo: TStringField;
    qryAttachDateAdded: TDateTimeField;
    qryAttachFileName: TStringField;
    qryAttachUserID: TStringField;
    qryAttachCategory: TStringField;
    qryNotesRefNo: TStringField;
    qryNotesEntCode: TStringField;
    qryNotesName: TStringField;
    qryNotesName2: TStringField;
    qryNotesTelNo1: TStringField;
    qryNotesTelNo2: TStringField;
    qryNotesTelNo3: TStringField;
    qryNotesEmployer: TStringField;
    qryNotesBranch: TStringField;
    qryNotesUpdateUser: TStringField;
    qryNotesUpdateDate: TDateTimeField;
    qryNotesUpdateDetail: TStringField;
    ...
    procedure qryNotesAfterEdit(DataSet: TDataSet);
    procedure qryNotesCalcFields(DataSet: TDataSet);
  private
...
procedure TdtmNotes.qryNotesAfterEdit(DataSet: TDataSet);
begin
  qryNotes.FieldByName('UpdateUser').AsString := dtmMain.CurrentID;
  qryNotes.FieldByName('UpdateDate').AsDateTime := Date;
end;

procedure TdtmNotes.qryNotesCalcFields(DataSet: TDataSet);
begin
  if not qryNotes.FieldByName('UpdateUser').IsNull then
    qryNotes.FieldByName('UpdateDetail').AsString :=
      qryNotes.FieldByName('UpdateUser').AsString + '  ' +
      FormatDateTime('dd/mm/yyyy',qryNotes.FieldByName('UpdateDate').AsDateTime);
end;
