...
uses
  ...
  Unit32, ImgList, DBGrdClr, DBStyleGrid, ADODB;
...
//  grdLookup: TDBGrid;
    ...
    procedure grdLookupDrawColumnCell(Sender: TObject; const Rect: TRect;
  ...
  private
    ...
    procedure SetOtherFilter(const Value: String);
  public
    { Public declarations }
    property OtherFilter: String read FOtherFilter write SetOtherFilter;
...
begin
  ...
  begin
    FilterDataSet(dtsLookup.DataSet,OtherFilter)
  end
  else
  begin
    if UseLike then
...
procedure TfrmLookUp.grdLookupDrawColumnCell(Sender: TObject;
...
procedure TfrmLookUp.SetOtherFilter(const Value: String);
begin
  FOtherFilter := Value;
end;
